...
5. Jalankan project mengikuti panduan di README bagian "Untuk Developer"

6. Buka file `krabat-isyarat.sb3` di root repo lewat [Scratch offline editor](https://scratch.mit.edu/download) atau [TurboWarp](https://turbowarp.org/editor) — keduanya bisa langsung buka file `.sb3`
7. Edit project, lalu simpan ulang sebagai `.sb3` dengan nama file yang sama
...
- Kalau ikut update build APK (folder `www/`, `android/`), pastikan itu juga tetap bisa di-build: jalankan `npm install` lalu `npx cap sync android`
- Pastikan aplikasi tetap bisa dijalankan/build tanpa error
